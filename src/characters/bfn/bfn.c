...
static const CharFrame char_bfn_frame[] = {
	{BFN_ArcMain_BFN0, {  0,   0, 102,  99}, { 53,  92}}, //0 idle 1
	{BFN_ArcMain_BFN0, {103,   0, 102,  99}, { 53,  92}}, //1 idle 2
	{BFN_ArcMain_BFN0, {  0, 100, 102, 101}, { 53,  94}}, //2 idle 3
	{BFN_ArcMain_BFN0, {103, 100, 103, 104}, { 53,  97}}, //3 idle 4
	{BFN_ArcMain_BFN1, {  0,   0, 103, 104}, { 53,  97}}, //4 idle 5
	
	{BFN_ArcMain_BFN1, {104,   0,  96, 102}, { 56,  95}}, //5 left 1
	{BFN_ArcMain_BFN1, {  0, 105,  94, 102}, { 54,  95}}, //6 left 2
	
	{BFN_ArcMain_BFN1, { 95, 103,  94,  89}, { 52,  82}}, //7 down 1
	{BFN_ArcMain_BFN2, {  0,   0,  94,  90}, { 52,  83}}, //8 down 2
	
	{BFN_ArcMain_BFN2, { 95,   0,  93, 112}, { 41, 104}}, //9 up 1
	{BFN_ArcMain_BFN2, {  0,  91,  94, 111}, { 42, 103}}, //10 up 2
	
	{BFN_ArcMain_BFN2, { 95, 113, 102, 102}, { 41,  95}}, //11 right 1
	{BFN_ArcMain_BFN3, {  0,   0, 102, 102}, { 41,  95}}, //12 right 2
	
	{BFN_ArcMain_BFN3, {103,   0,  99, 105}, { 54,  98}}, //13 peace 1
	{BFN_ArcMain_BFN3, {  0, 103, 104, 103}, { 54,  96}}, //14 peace 2
	{BFN_ArcMain_BFN3, {105, 106, 104, 104}, { 54,  97}}, //15 peace 3
	
	{BFN_ArcMain_BFN4, {  0,   0, 128, 128}, { 53,  92}}, //16 sweat 1
	{BFN_ArcMain_BFN4, {128,   0, 128, 128}, { 53,  93}}, //17 sweat 2
	{BFN_ArcMain_BFN4, {  0, 128, 128, 128}, { 53,  98}}, //18 sweat 3
	{BFN_ArcMain_BFN4, {128, 128, 128, 128}, { 53,  98}}, //19 sweat 4
	
	{BFN_ArcMain_BFN5, {  0,   0,  93, 108}, { 52, 101}}, //20 left miss 1
	{BFN_ArcMain_BFN5, { 94,   0,  93, 108}, { 52, 101}}, //21 left miss 2
	
	{BFN_ArcMain_BFN5, {  0, 109,  95,  98}, { 50,  90}}, //22 down miss 1
	{BFN_ArcMain_BFN5, { 96, 109,  95,  97}, { 50,  89}}, //23 down miss 2
	
	{BFN_ArcMain_BFN6, {  0,   0,  90, 107}, { 44,  99}}, //24 up miss 1
	{BFN_ArcMain_BFN6, { 91,   0,  89, 108}, { 44, 100}}, //25 up miss 2
	
	{BFN_ArcMain_BFN6, {  0, 108,  99, 108}, { 42, 101}}, //26 right miss 1
	{BFN_ArcMain_BFN6, {100, 109, 101, 108}, { 43, 101}}, //27 right miss 2
	...
	{BFN_ArcDead_Dead1, {  0,   0, 128, 128}, { 53,  98}}, //27 dead1 0
	{BFN_ArcDead_Dead1, {128,   0, 128, 128}, { 53,  98}}, //28 dead1 1
	{BFN_ArcDead_Dead1, {  0, 128, 128, 128}, { 53,  98}}, //29 dead1 2
	{BFN_ArcDead_Dead1, {128, 128, 128, 128}, { 53,  98}}, //30 dead1 3
	
	{BFN_ArcDead_Dead2, {  0,   0, 128, 128}, { 53,  98}}, //31 dead2 body twitch 0
	{BFN_ArcDead_Dead2, {128,   0, 128, 128}, { 53,  98}}, //32 dead2 body twitch 1
	{BFN_ArcDead_Dead2, {  0, 128, 128, 128}, { 53,  98}}, //33 dead2 balls twitch 0
	{BFN_ArcDead_Dead2, {128, 128, 128, 128}, { 53,  98}}, //34 dead2 balls twitch 1
};
...
Character *Char_BFN_New(fixed_t x, fixed_t y)
{
	...
	const char **pathp = (const char *[]){
		"bf0.tim",   //BFN_ArcMain_BFN0
		"bf1.tim",   //BFN_ArcMain_BFN1
		"bf2.tim",   //BFN_ArcMain_BFN2
		"bf3.tim",   //BFN_ArcMain_BFN3
		"bf4.tim",   //BFN_ArcMain_BFN4
		"bf5.tim",   //BFN_ArcMain_BFN5
		"bf6.tim",   //BFN_ArcMain_BFN6
